    ...
    <form class="card-body" method="POST" action="/archers/store">
      ...
      <div class="row g-6">
        ...
        <div class="col-md-6">
          ...
          <input type="text" id="knownAs" class="form-control" name="knownAs">
        </div>
        ...
        <div class="col-md-6">
          ...
          <input type="text" id="nationalId" class="form-control" name="nId">
        </div>
      ...
      <div class="row g-6">
        <div class="col-md-6">
          <label class="form-label" for="cgdSelect">Current Grading Dominant</label>
      ...
      <div class="row g-6">
        <div class="col-md-6">
          <label class="form-label" for="exampleFormControlSelect1">Current Proficiency</label>
        ...
        <div class="col-md-6">
          <div class="form-password-toggle">
            ...
            <div class="input-group input-group-merge">
              ...
              <span class="input-group-text cursor-pointer" id="multicol-confirm-password2"><i class=""></i></span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row g-6">
        ...
        <div class="col-md-6">
          <label class="form-label" for="exampleFormControlSelect1">Dominant Hand</label>
...
<script>
  function calculateAgeDetails() {
    ...
    const optionsByCategory = {
      "Cub": ["CNG", "CS1", "CS2", "CS3", "CA1", "CA2", "CA3", "CM1", "CM2", "CM3"],
      "Junior": ["JNG", "JS1", "JS2", "JS3", "JA1", "JA2", "JA3", "JM1", "JM2", "JM3"],
      "Adult": ["ANG", "AS1", "AS2", "AS3", "AA1", "AA2", "AA3", "AM1", "AM2", "AM3"]
    };
