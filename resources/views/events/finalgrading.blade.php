    ...
    <div class="card">
        ...
        <div class="table-responsive">
           ...
           <tr>
                   ...
                   <td>
                    <div class="col-sm-6 col-lg-10">
                    <input type="text" class="form-control"  name="time1" placeholder="HH:MM" id="flatpickr-time" />
                 
                    </div>
                </td>
                <td>
                    <div class="col-sm-6 col-lg-10">
                    <input type="text" class="form-control" name="time2" placeholder="HH:MM" id="flatpickr-time1" />
                        
                    </div>
                </td>
                <td>
                    <div class="col-sm-6 col-lg-10">
                    <input type="text" class="form-control" name="time3" placeholder="HH:MM" id="flatpickr-time" />
                     
                    </div>
                </td>
                <td>
                    <div class="col-sm-6 col-lg-10">
                    <input type="text" class="form-control" name="time4" placeholder="HH:MM" id="flatpickr-time" />
                
                    </div>
                </td>
                <td>
                    <div class="col-sm-6 col-lg-10">
                    <input type="text" class="form-control" name="time5" placeholder="HH:MM" id="flatpickr-time" />
                    </div>
                </td>
                <td>
                    <div class="col-sm-6 col-lg-10">
                    <input type="text" class="form-control" name="time6" placeholder="HH:MM" id="flatpickr-time" />
                    </div>
                </td>
                <td>
                    <div class="col-sm-6 col-lg-10">
                    <input type="text" class="form-control" name="time7" placeholder="HH:MM" id="flatpickr-time" />
                    </div>
                </td>
                <td><div class="col-sm-6 col-lg-10">
                <input type="text" class="form-control" name="time8" placeholder="HH:MM" id="flatpickr-time" />
                </div></td>
                      
                      <td><div class="col-sm-6 col-lg-10">
                      <input type="text" class="form-control" name="time9" placeholder="HH:MM" id="flatpickr-time" />
                    </div></td>
         </tr>
