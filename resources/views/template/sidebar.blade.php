<aside id="layout-menu" class="layout-menu menu-vertical menu">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bold ms-2 fs-5">Qurtuba Furusiyyah</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active">
              ...
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Layouts">Archers</div>
              </a>

              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="/archers/create" class="menu-link">
                    <div data-i18n="Collapsed menu">Create Archers</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="/archers/index" class="menu-link">
              ...
              <li class="menu-item">
                ...
                <li class="menu-item">
                  <a href="/events/create" class="menu-link">
                    <div data-i18n="Collapsed menu">Create Event</div>
                  </a>
                </li>
                <li class="menu-item">
